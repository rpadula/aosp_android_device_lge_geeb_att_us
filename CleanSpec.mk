...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/system/build.prop)
...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/geeb_att_us/obj/EXECUTABLES/mm-vdec-omx-test*_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/symbols/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/geeb_att_us/obj/EXECUTABLES/charger_touch_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/symbols/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/obj/NOTICE_FILES/src/system/bin/charger_touch.txt)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb_att_us/root/default.prop)
